...
struct td {
	__u32 hwINFO;
	__u32 hwCBP_DMA;		/* Current Buffer Pointer */
	__u32 hwNextTD_DMA;		/* Next TD Pointer */
	__u32 hwBE_DMA;		/* Memory Buffer End Pointer */
	__u32 CBP;		/* Current Buffer Pointer */
	__u32 NextTD;		/* Next TD Pointer */
	__u32 BE;		/* Memory Buffer End Pointer */
