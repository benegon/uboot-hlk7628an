...
printf("## RH_C_HUB_LOCAL_POWER\n");
			OK(0);
		case (RH_C_HUB_OVER_CURRENT):
printf("## RH_C_HUB_OVER_CURRENT\n");
...
printf("## RH_CLEAR_FEATURE | RH_OTHER | RH_CLASS :%d\n", wValue);
		switch (wValue) {
...
printf("## RH_SET_FEATURE | RH_OTHER | RH_CLASS: %d\n", wValue);
		switch (wValue) {
