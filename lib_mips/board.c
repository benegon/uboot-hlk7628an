...
#define BOOT_HILINK_4B 0x78564533
/* TRIQ operation 4, RECORD write */
#define TRIQ_I2C_SET_4B "SW042033455678SRP"
...
int manual_select = 0;
int hlk_uboot_update_firmware = 0;
int hlk_uboot_update_uboot = 0;
...
void printBanner(void)
{
    ...
    printf("\n\n");
    printf("\n");
#if defined HLK_7688A
    printf("  _    _   _        _  __  ______     __     ___     ___                 \n");
    printf(" | |  | | | |      | |/ / |____  |   / /    / _ \\   / _ \\      /\\        \n");
    printf(" | |__| | | |      | ' /      / /   / /_   | (_) | | (_) |    /  \\       \n");
    printf(" |  __  | | |      |  <      / /   | '_ \\   > _ <   > _ <    / /\\ \\      \n");
    printf(" | |  | | | |____  | . \\    / /    | (_) | | (_) | | (_) |  / ____ \\     \n");
    printf(" |_|  |_| |______| |_|\\_\\  /_/      \\___/   \\___/   \\___/  /_/    \\_\\    \n");
    hlk_type = "7688A";
#elif defined HLK_7688NS
    printf("  _    _   _        _  __  ______     __    ___     ___    _   _    _____  \n");
    printf(" | |  | | | |      | |/ / |____  |   / /   |__ \\   / _ \\  | \\ | |  / ____| \n");
    printf(" | |__| | | |      | ' /      / /   / /_      ) | | (_) | |  \\| | | (___   \n");
    printf(" |  __  | | |      |  <      / /   | '_ \\    / /   > _ <  | . ` |  \\___ \\  \n");
    printf(" | |  | | | |____  | . \\    / /    | (_) |  / /_  | (_) | | |\\  |  ____) | \n");
    printf(" |_|  |_| |______| |_|\\_\\  /_/      \\___/  |____|  \\___/  |_| \\_| |_____/  \n");

    hlk_type = "7628NS";
#elif defined HLK_7628N
    printf("  _    _   _        _  __  ______     __    ___     ___    _   _   \n");
    printf(" | |  | | | |      | |/ / |____  |   / /   |__ \\   / _ \\  | \\ | |  \n");
    printf(" | |__| | | |      | ' /      / /   / /_      ) | | (_) | |  \\| |  \n");
    printf(" |  __  | | |      |  <      / /   | '_ \\    / /   > _ <  | . ` |  \n");
    printf(" | |  | | | |____  | . \\    / /    | (_) |  / /_  | (_) | | |\\  |  \n");
    printf(" |_|  |_| |______| |_|\\_\\  /_/      \\___/  |____|  \\___/  |_| \\_|  \n");
    hlk_type = "7628N";
#elif defined HLK_7688AS

    printf("  _    _   _        _  __  ______     __     ___     ___                _____   \n");
    printf(" | |  | | | |      | |/ / |____  |   / /    / _ \\   / _ \\      /\\      / ____|  \n");
    printf(" | |__| | | |      | ' /      / /   / /_   | (_) | | (_) |    /  \    | (___    \n");
    printf(" |  __  | | |      |  <      / /   | '_ \\   > _ <   > _ <    / /\\ \\    \\___ \\   \n");
    printf(" | |  | | | |____  | . \\    / /    | (_) | | (_) | | (_) |  / ____ \\   ____) |  \n");
    printf(" |_|  |_| |______| |_|\\_\\  /_/      \\___/   \\___/   \\___/  /_/    \\_\\ |_____/   \n");
    hlk_type = "7688AS";
#elif defined HLK_RM28E
    printf("  _    _   _        _  __  ___     ___    ______   \n");
    printf(" | |  | | | |      | |/ / |__ \\   / _ \\  |  ____|  \n");
    printf(" | |__| | | |      | ' /     ) | | (_) | | |__     \n");
    printf(" |  __  | | |      |  <     / /   > _ <  |  __|    \n");
    printf(" | |  | | | |____  | . \\   / /_  | (_) | | |____   \n");
    printf(" |_|  |_| |______| |_|\\_\\ |____|  \\___/  |______|  \n");
    hlk_type = "RM28E";
#elif defined HLK_7688AL
	printf(" __    __   __       __  ___     ______     __     ___     ___        ___       __      \n");
	printf("|  |  |  | |  |     |  |/  /    |____  |   / /    / _ \\   / _ \\      /   \\     |  |      \n");
	printf("|  |__|  | |  |     |  '  /         / /   / /_   | \(_\) | | \(_\) |    /  ^  \\    |  | 	\n");
	printf("|   __	 | |  |     |    <         / /   | '_ \\   > _ <   > _ <    /  /_\\  \\   |  | 	\n");
	printf("|  |  |  | |  `----.|  .  \\       / /    | \(_\) | | \(_\) | | \(_\) |  /  _____  \\  |  `----.\n");
	printf("|__|  |__| |_______||__|\\__\\     /_/      \\___/   \\___/   \\___/  /__/     \\__\\ |_______|\n");
	hlk_type = "7688AL";
#elif defined HLK_7628NL
	printf(" __    __   __       __  ___     ______     __    ___     ___   .__   __.  __      \n");
	printf("|  |  |  | |  |     |  |/  /    |____  |   / /   |__ \\   / _ \\  |  \\ |  | |  |     \n");
	printf("|  |__|  | |  |     |  '  /         / /   / /_      \) | | \(_\) | |   \\|  | |  |     \n");
	printf("|   __   | |  |     |    <         / /   | '_ \\    / /   > _ <  |  . `  | |  |     \n");
	printf("|  |  |  | |  `----.|  .  \\       / /    | \(_\) |  / /_  | \(_\) | |  |\\   | |  `----.\n");
	printf("|__|  |__| |_______||__|\\__\\     /_/      \\___/  |____|  \\___/  |__| \\__| |_______|\n");

	hlk_type = "7628NL";
#elif defined HLK_7688AF
	hlk_type = "7688AF";
#elif defined HLK_7628NF
	hlk_type = "7628NF";
#endif

    printf("-------------------------------------------------------------------------\n");
    printf("             https://github.com/gnubee-git\n");
    printf("-------------%s build %s %s--------------------\n", hlk_type, __DATE__, __TIME__);
		printf("MTRIQ:C,D\n");
    printf("-------------------------------------------------------------------------\n");
}
...
#define SEL_ENV_WRITE_FLASH       		0xa
...
int tftp_config(int type, char *argv[])
{
	...
	printf("(%s) ", devip);
	if (hlk_uboot_update_uboot || hlk_uboot_update_firmware) {
	} else {
		input_value(devip);
	}
	setenv("ipaddr", devip);
	...
	if (	type == SEL_LOAD_BOOT_SDRAM 
		...
		//s = "7628E.bin";
		s = "firmware.bin";
	} else if (SEL_ENV_WRITE_FLASH == type) {
		argv[1] = "0x80100000";

		printf("\tInput Uboot Env filename ");
		s = "env.bin";
	}
...
#if 1
int burn_env(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	tftp_config(SEL_ENV_WRITE_FLASH, argv);
	argc= 3;
	do_tftpb(cmdtp, 0, argc, argv);
	if (NetBootFileXferSize > CFG_CONFIG_SIZE) {
		printf("Abort: bootloader size %d too big! \n", NetBootFileXferSize);
	}
#if defined (CFG_ENV_IS_IN_SPI)
	else {
		unsigned int load_address = simple_strtoul(argv[1], NULL, 16);
		raspi_erase_write((char *)load_address, CFG_ENV_ADDR-CFG_FLASH_BASE, NetBootFileXferSize);
	}
#endif
...
#if defined USE_4BYTE
extern void flash_to_4byte(void);
#endif
void board_init_r (gd_t *id, ulong dest_addr)
{
	...
	manual_select = 1;
	hlk_uboot_update_uboot = 0;
	hlk_uboot_update_firmware = 0;
#endif
...
#if defined No_Print
    if (readwps() == 0) {
		printf("Probe WPS Key Is Press.\n");
		i = 0;
		do {
			if (readwps() != 0) {
				break;
			}
#define	HLK_UBOOT_TIME_1 300
#define	HLK_UBOOT_TIME_2 800
#define HLK_UBOOT_TIME_3 1200

			if ( (i >= HLK_UBOOT_TIME_1) && (i < HLK_UBOOT_TIME_2) ) {
				BootType = '2';
				hlk_uboot_update_firmware = 1;
				control_power_led(1);
					// 双闪
			} else if ( (i >= HLK_UBOOT_TIME_2) && (i < HLK_UBOOT_TIME_3) ) {
				BootType = '9';
				hlk_uboot_update_uboot = 1;
				control_power_led(0);
					// 三闪
			} else if (i >= HLK_UBOOT_TIME_3) {
				manual_select = 1;
				hlk_uboot_update_uboot = 0;
				hlk_uboot_update_firmware = 0;
				control_power_led(1);
		...
		while (timer1 > 0) {
			...
			for (i = 0; i < 100; ++i) {
				...
				if ((my_tmp = tstc()) != 0) {	/* we got a key press	*/
					...
					BootType = getc();
					if ((BootType < '0' || BootType > '5') && (BootType != '7') && (BootType != '8') && (BootType != '9') && (BootType != '6'))
						BootType = '3';
					printf("\n\rYou chose %c\n\n", BootType);
					break;
				}
...

	{
		...
		case '2':
			if (!hlk_uboot_update_firmware) {	//按住wps键 升级固件 不需要提示 直接使用默认参数进行升级
		...
		case '9':
            ...
            control_power_led(1);
#endif
			if (!hlk_uboot_update_uboot) {	//按住wps键 升级uboot 不需要提示 直接使用默认参数进行升级
...
int do_invalidate_linux(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[]){
	return raspi_erase(CFG_KERN_ADDR, 0x10000);
}

U_BOOT_CMD(
	invalidate_linux,	1,	1,	do_invalidate_linux,
	"invalidate_linux - erase first sector of linux\n",
);
